                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            <h3 class="card-title">Spravovať objednávky</h3>
                        </div>

                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 text-end">
                            <button type="button" name="add" id="addOrder" class="btn btn-primary btn-sm rounded-0"><i class="far fa-plus-square"></i> Pridať objednávku</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-plus"></i> Pridať objednávku</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default border rounded-0" data-bs-dismiss="modal">Zavrieť</button>
                </div>
            </div>
        </div>
    </div>
