$(document).ready(function() {
    $('#addSupplier').click(function() {
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Pridať dodávateľa");
        $('#action').val("Pridať");
    ...
    $(document).on('click', '.update', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').html("<i class='fa fa-edit'></i> Upraviť dodávateľa");
    ...
    $(document).on('click', '.delete', function() {
        ...
        if (confirm("Naozaj chcete odstrániť tohoto dodávateľa?")) {
            $.ajax({
                url: "action.php",
                method: "POST",
                data: { supplier_id: supplier_id, btn_action: btn_action },
