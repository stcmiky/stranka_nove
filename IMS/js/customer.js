$(document).ready(function() {
    $('#addCustomer').click(function() {
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Pridať zákazníka");
    });
    ...
    $(document).on('click', '.update', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').html("<i class='fa fa-edit'></i> Upraviť zákazníka");
                $('#userid').val(userid);
    ...
    $(document).on('click', '.delete', function() {
        ...
        if (confirm("Naozaj chcete odstrániť tohoto zákazníka?")) {
            $.ajax({
                url: "action.php",
                method: "POST",
                data: { userid: userid, btn_action: btn_action },
